...
#
#     from plexfix import metadata
#
# However, when we do this, we also import `plexfix/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        ...
        # 'gui_scripts': [
        #     'plexfix_gui = plexfix.gui:entry_point'
        # ]
    }
)
